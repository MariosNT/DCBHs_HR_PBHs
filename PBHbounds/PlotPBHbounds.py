...
labellist = np.loadtxt(listfile, usecols=(0,), dtype=str)
...
plt.text(5e-11, 1.2e-4, 'X-rays constraints', fontsize=12)


# ## massless constraints
# plt.axvline(x=6.5e-17, ls='-', lw=2, c='tab:blue')
# plt.annotate('', xy=(Msun_max, 3.8e-5),
#              xycoords='data',
#              xytext=(6.5e-17, 3.8e-5),
#              textcoords='data',
#              arrowprops=dict(arrowstyle= '->',
#                              color='tab:blue',
#                              lw=2,
...
#            )
# plt.text(5e-16, 4.5e-5, r'$m_{\rm HR}\rightarrow0$', fontsize=12)


# ## Greybody constraints
# plt.axvline(x=3.5e-11, ls='-', lw=2, c='tab:blue')
# plt.annotate('', xy=(Msun_max, 6.8e-5),
#              xycoords='data',
#              xytext=(3.5e-11, 6.8e-5),
#              textcoords='data',
#              arrowprops=dict(arrowstyle= '->',
#                              color='tab:blue',
#                              lw=2,
...
#            )
# plt.text(5e-9, 7.8e-5, r'$\Gamma_{\rm greybody}\rightarrow1$', fontsize=12)
